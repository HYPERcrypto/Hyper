...
const string strMessageMagic = "Hyper Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Hyper
    bool fStrictPayToScriptHash = true; // Always active in Hyper
...
string GetWarnings(string strFor)
{
    ...
    {
        nPriority = 100;
        strStatusBar = "Finishing Syncing, Please be patient.";
    }
