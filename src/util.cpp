...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Hyper
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Hyper
    // Mac: ~/Library/Application Support/Hyper
    // Unix: ~/.Hyper
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hyper";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Hyper.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Hyperd.pid"));
