#############################################################################
# Makefile for building: Hyper-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Dec 14 16:42:49 2014
# Project:  Hyper-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile Hyper-qt.pro
#############################################################################
...
CFLAGS        = -m64 -pipe -msse2 -O2 -D_REENTRANT -Wall -W $(DEFINES)
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -msse2 -w -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -IC:/deps/boost -Ic:/deps/db/build_unix -Ic:/deps/ssl/include -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc -lrt -LC:/deps/boost/stage/lib -Lc:/deps/db/build_unix -Lc:/deps/ssl -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/perch/coins/Hyper-main/Hyper/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Hyper-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
/home/perch/coins/Hyper-main/Hyper/build/build.h: FORCE
	cd /home/perch/coins/Hyper-main/Hyper; /bin/sh share/genbuild.sh /home/perch/coins/Hyper-main/Hyper/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/Hyper-16.png \
		src/qt/res/icons/Hyper-128.png \
...
qrc_Background.cpp: src/qt/Background.qrc \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name Background src/qt/Background.qrc -o qrc_Background.cpp
